                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                           ...
                           <img class="rounded-circle header-profile-user" src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="Header Avatar">
...
<?php /**PATH D:\xampp\htdocs\vitkom-admin-panel\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>