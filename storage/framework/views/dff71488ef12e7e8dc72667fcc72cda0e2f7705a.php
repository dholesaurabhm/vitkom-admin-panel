...
<?php $__env->startSection('title'); ?>
  <?php echo e($title); ?> Seller Details
                    ...
                    <div class="live-preview">
                        ...
                        <input type="hidden" name="status" id="status" value="<?php echo e($status); ?>">
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="placeholderInput" class="form-label">Registered Name Of Shop <span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" id="shop_name"  placeholder="Enter Registered Name Of Shop" name="shop_name">
                                </div>
                            </div>
                      
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="placeholderInput" class="form-label">Nick Name Of Shop <span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" id="nick_name"
                                        placeholder="Enter Nick Name Of Shop (Which displayed on Front As Store Name)" name="nick_name">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-6">
                                <div>
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="placeholderInput" class="form-label">Support Contact No For Shop <span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" id="contact_no"  placeholder="Enter Support Contact No for Shop" name="contact_no">
                                </div>
                            </div>
                            ...
                            <!--end col-->
                            <h5 class="fs-14">Company Address</h5>
        ...
        $.ajax({
                ...
                success: function(result) {
                    ...
                    if(result.success==true)
                    {
                        ...
                        $('#shop_name').val((data.company.company_name)??''); 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\order_now_admin\resources\views/seller_form.blade.php ENDPATH**/ ?>