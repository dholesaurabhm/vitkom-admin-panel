    ...
    $(".seller_list").select2({
     ...
     var product_table =$('#product_list').DataTable({
        ...
        columns: [
            ...
            { data: 'product_name' },
            { data: 'price',render:function(data,type,row){ return  row.currency +' '+row.price } },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\order_now_admin\resources\views/product.blade.php ENDPATH**/ ?>