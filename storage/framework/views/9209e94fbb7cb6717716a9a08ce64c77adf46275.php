...
<title>Shop</title>
<link rel="stylesheet" href="<?php echo e(asset('customer/css/swiper.css')); ?>">
...
<body id="mobile_wrap">
                ...
                <div class="page-content">
                    <div class="navbarpages navbarpagesbg">
                        ...
                        <a href="#" data-panel="left" class="open-panel">
                            <img src="<?php echo e(asset('customer/images/icons/white/menu.png')); ?>" alt="" title="" /></a>
                        </div>			
                        <div class="navbar_right">
                            <a href="#" data-panel="right" class="open-panel">
                                <img src="<?php echo e(asset('customer/images/icons/white/user.png')); ?>" alt="" title="" />
                            </a>
                        </div>
                        <div class="navbar_right">
                            <a href="cart" data-view=".view-main">
                                <img src="<?php echo e(asset('customer/images/icons/white/cart.png')); ?>" alt="" title="" />
    ...
    <script src="<?php echo e(asset('customer/js/jquery-3.3.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('customer/js/jquery.validate.min.js')); ?>" ></script>
    <script src="<?php echo e(asset('customer/js/swiper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/assets/js/comman.js')); ?>"></script>
    <?php echo $__env->yieldContent('script'); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\erp2\resources\views/customer/app.blade.php ENDPATH**/ ?>