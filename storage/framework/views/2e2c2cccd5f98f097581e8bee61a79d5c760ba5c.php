...
<div class="row">
    <div class="col">
        ...
        <div class="h-100">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6" id="earn_div">
                    <!-- card -->
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" id="earn" data-target="1">0</span>
                                    </h4>
                                    <a href="<?php echo e(url('/orders')); ?>" class="text-decoration-underline">View net
                                        earnings</a>
                                </div>
                ...
                <div class="col-xl-3 col-md-6" id="orders_div">
                    <!-- card -->
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="1" id="orders">0</span></h4>
                                    <a href="<?php echo e(url('/orders')); ?>" class="text-decoration-underline">View all orders</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-xl-3 col-md-6" id="products_div">
                    <!-- card -->
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="1" id="products">0</span>
                                    </h4>
                                    <a href="<?php echo e(url('/products')); ?>" class="text-decoration-underline">View All Products</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-xl-3 col-md-6" id="sellers_div" style="display:<?php echo e(Auth::user()->role==1 ? 'block':'none'); ?>;">
                    <!-- card -->
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="1" id="sellers">0</span>
                                    </h4>
                                    <a href="<?php echo e(url('/sellers')); ?>" class="text-decoration-underline">See details</a>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
            ...
            <div class="row" style="display:<?php echo e(Auth::user()->role==1 ? 'block':'none'); ?>;">
                <div class="col-lg-12">
                    <div class="card">
                    ...
                    <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-muted lh-base">Refer a new seller to us and earn RM100
                                    per refer.</p>
        ...
        // },
                success: function(result) {
                    ...
                    if(result.success==true)
                    {
                      ...
                      console.log(orders+products+sellers)
                       $('#orders').attr('data-target',orders).text(orders);
                      $('#sellers').attr('data-target',sellers).text(sellers);
                      $('#products').attr('data-target',products).text(products);
                       ...
                       // for(var i = 0; i < (result.data.product).length; i++) {
                        (result.data).forEach(function(el, index) {
                           list+= ` <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="${el.logo}" alt="" class="avatar-sm p-2">
                                                </div>
                                                <div>
                                                    <h5 class="fs-14 my-1 fw-medium">
                                                        <a href="apps-ecommerce-seller-details.html" class="text-reset">${el.company_name}</a>
                                                    </h5>
                                                    <span class="text-muted">${el.name}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="text-muted">${el.email_id}</span>
                                        </td>
                                        <td>
                                            <p class="mb-0">8547</p>
                                        ...
                                        <td>
                                            <span class="text-muted">RM541200</span>
                                        </td>
                                        
                                    </tr>`;
                            });
                        $('#top_seller').append(list);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\order_now_admin\resources\views/index.blade.php ENDPATH**/ ?>