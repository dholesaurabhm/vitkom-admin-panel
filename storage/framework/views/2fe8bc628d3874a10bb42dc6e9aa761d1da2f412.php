                        ...
                        <div class="mt-3 mt-lg-0">
                            <form action="javascript:void(0);">
                                <div class="row g-3 mb-0 align-items-center">
                                    ...
                                    <!--end col-->
                                    <div class="col-auto">
                                        <a  class="btn btn-soft-success" href="<?php echo e(url('/add_product')); ?>"><i class="ri-add-circle-line align-middle me-1"></i>
                                            Add Product</a>
                                    </div>
                                    <!--end col-->
                                    <div class="col-auto">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RM<span class="counter-value" data-target="559.25">0</span>k
                                    </h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RM<span class="counter-value" data-target="165.89">0</span>k
                                    </h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header p-0 border-0 bg-soft-light">
                            <div class="row g-0 text-center">
                                ...
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1">RM<span class="counter-value" data-target="22.89">0</span>k</h5>
                                ...
                                <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM29.00</h5>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM1,798</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM85.20</h5>
                                                <span class="text-muted">Price</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM2982</h5>
                                                <span class="text-muted">Amount</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM14.00</h5>
                                                <span class="text-muted">Price</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM1120</h5>
                                                <span class="text-muted">Amount</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM127.50</h5>
                                                <span class="text-muted">Price</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM7140</h5>
                                                <span class="text-muted">Amount</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM54</h5>
                                                <span class="text-muted">Price</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RM3996</h5>
                                                <span class="text-muted">Amount</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">RM75030</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">RM45600</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">RM29456</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">RM11260</span>
                                            </td>
                                            <td>
                                ...
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Clothes</td>
                                            <td>
                                                <span class="text-success">RM109.00</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-success">RM149.00</span>
                                            </td>
                                            <td>Micro Design</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-success">RM215.00</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Furniture</td>
                                            <td>
                                                <span class="text-success">RM199.00</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-success">RM330.00</span>
                                            </td>
                                            <td>iTest Factory</td>
                                            <td>
                                                <span class="badge badge-soft-success">Paid</span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order_now_admin\resources\views/index.blade.php ENDPATH**/ ?>