            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(url('/edit_seller/'.Auth::user()->seller_id)); ?>"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\order_now_admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>