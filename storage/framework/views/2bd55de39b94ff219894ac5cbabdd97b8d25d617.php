                            ...
                            <div class="col-sm-6 text-end">
                                <div>
                                    <a href="<?php echo e(url('/add_product')); ?>" class="btn btn-success" ><i
                                            class="ri-add-line align-bottom me-1"></i> Add Menu</a>
                                </div>
                            </div>
...
<script>
    ...
    $(".seller_list").select2({
     ...
     var product_table =$('#product_list').DataTable({
        proccessing: true,
        serverSide: true,
        searching: true,
        bFilter: true,
        ...
        columns: [
            ...
            { data: 'section_name'},
            { data: 'product_type'},
            { data: 'image',render: function (data, type, row, meta) {return `<img src="${file_url}${data}" class="w-50 h-50">` }},
            { data: 'stock',render: function (data, type, row, meta) {return (data==1) ? '<span class="badge bg-danger">No</span>' :'<span class="badge bg-success">Yes</span>'} },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp2\resources\views/product.blade.php ENDPATH**/ ?>