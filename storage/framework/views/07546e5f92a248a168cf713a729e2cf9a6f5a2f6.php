                                    ...
                                    <form id="register">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control"
                                                ...
                                                placeholder="Enter Mobile NO" required maxlength="12">
                ...
                <div class="mt-4" id="verify_div" style="display:none;">
                    <div class="mb-2">
                        <label for="otp" class="form-label">Enter OTP <span
                                class="text-danger">*</span></label>
                        <input type="number"  class="form-control" name="otp" id="otp" placeholder="Enter OTP" maxlength="6" >
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order_now_admin\resources\views/auth/register.blade.php ENDPATH**/ ?>