...
<?php echo $__env->renderComponent(); ?>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 text-end">
                                <div>
                                    ...
                                    data-bs-target="#showModal"><i class="ri-add-fill me-1 align-bottom"></i> Add District</button>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="state_list" class="display table table-bordered dt-responsive" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr. No</th>
                                                    <th>Short Name</th>
                ...
                <div class="modal-body">
                    <div class="mt-2 text-center">
                        ...
                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                            <h4>Are you Sure ?</h4>
                            <p class="text-muted mx-4 mb-0">Are you Sure You want to Remove this State?</p>
                        </div>
                    </div>
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn w-sm btn-danger" id="delete-state">Yes, Delete It!</button>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <form id="state_form" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" class="form-control curr_date" id="state_date" name="state_date" data-provider="flatpickr" data-date-format="Y-m-d" data-deafult-date="<?php echo e(date('Y-m-d')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div>
                        ...
                        <div class="col-lg-12">
                            <div>
                               ...
                               <select name="country_id" id="country_id" class="form-select country_list">
                                <option></option>
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" id="continent_id" name="continent_id" class="form-control"  readonly />
                            </div>
                        </div>
...
<script>
   ...
   var continent=$('#country_id option:selected').data('continent_name');
   console.log(continent)
    $('#continent_id').val(continent)
  })
     var section_table =$('#District_list').DataTable({
        proccessing: true,
        serverSide: true,
        searching: true,
        bFilter: true,
    ...
    function opendeletmodel(id)
    {
        ...
        $('#removeItemModal').modal('show');
          $("#delete-state").replaceWith('<a href="#" class="btn btn-danger m-2" id="delete-state" onclick="deletestate('+id+')">Yes, Delete it</a>');
    }
    ...
    function deletestate(id)
      {
        ...
        $.ajax({
                ...
                data: {state_id:id,user_id:$('#user_id').val()},
      ...
      function savestate()
      {
        if($('#short_name').val() !='')
        {
            if($('#state_id').val() =='')
            {
                ...
                url=base_url+"state/update/"+$('#state_id').val()
            }
            $.ajax({
                type: "POST",
                url: url,
            ...
            toast_error('Please Enter state Name');
        }
      }
        ...
        $.ajax({
                ...
                success: function(result) {
                    ...
                    if(result.success==true)
                    {
                      ...
                      $('#state_id').val(result.data.id);
                      $('#state_date').val(result.data.state_date);
                      $('#name').val(result.data.name);
                      $('#code').val(result.data.code);
                      $('#country_id').val(result.data.country_id).trigger('change');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\AMS\resources\views/district.blade.php ENDPATH**/ ?>