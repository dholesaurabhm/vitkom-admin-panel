    ...
    <div class="loader"></div>
     ...
     <div class="cartcontainer">     
        <div id="cart">
          ...
          <a href="<?php echo e(url('checkout')); ?>" class="button_full btyellow">PROCEED TO CHECKOUT</a>           
                    ...
                    function cartlist()
                    {
                        ...
                        if(response.length>0)
                        {
                            response.forEach(function(resp) {
                                ...
                                <a href="#" class="item_delete" id="cartitem${resp.id}" onclick="deleteitem(${resp.id})"><img src="<?php echo e(asset('customer/images/icons/black/trash.png')); ?>" alt="" title="" class="trash"/></a>     
                                </div>`;
                            });
                        }
                        else
...
<?php $__env->stopSection(); ?>
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp2\resources\views/customer/cart.blade.php ENDPATH**/ ?>