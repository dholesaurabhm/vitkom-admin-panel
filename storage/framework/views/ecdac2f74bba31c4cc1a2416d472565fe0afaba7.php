                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card">
                        <div class="card-header" style="padding: 10px;">
                            ...
                            <div class="row g-4">
                                    <div class="col-md-12">
                                         <button class="btn btn-success upload_btn" onclick="showreportmodel('purchaseModel')">
                                            <i class="ri-add-line align-bottom me-1"></i> Import Purchase </button>
                                  
                                        <button class="btn btn-success upload_btn" onclick="showreportmodel('redemptionModel')">
                                            <i class="ri-add-line align-bottom me-1"></i> Import Redemption </button>
                                  
                                        <button class="btn btn-success upload_btn" onclick="showreportmodel('lifeModel')">
                                            <i  class="ri-add-line align-bottom me-1"></i> Import Life Insurance </button>
                             
                                        <button class="btn btn-success upload_btn" onclick="showreportmodel('healthModel')">
                                            <i class="ri-add-line align-bottom me-1"></i>  Import Health Insurance </button>   
                             
                                        <button class="btn btn-success upload_btn" onclick="showreportmodel('generalModel')">
                                            <i class="ri-add-line align-bottom me-1"></i>  Import General Insurance </button>       
                                    
                                        <button class="btn btn-success upload_btn" onclick="showreportmodel('bondModel')">
                                            <i class="ri-add-line align-bottom me-1"></i> Import Bonds </button>       
                                    </div>
...
<div class="modal fade" id="generalModel" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel">General Insurance Report</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="healthForm"  enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <div>
                                <label for="redemptionreport" class="form-label">Import General Insurance Report<span class="red">*</span></label>
                                <input type="file" name="transaction_file" class="form-control transaction_file" id="transaction_file" accept=".csv" required >
                            </div>
                        </div><!--end col-->
