...
<div class="row align-items-center h-100">
    <div class="col-8 mx-auto">
        <div class="text-center">
            <img id="profile-img" class="rounded-circle profile-img-card" src="<?php echo e(asset('/assets/images/logo.png')); ?>" />
            <p id="profile-name" class="profile-name-card"></p>
            <form  class="form-signin" action="<?php echo e(url('/checkCustomerlogin')); ?>" method="POST">
                <?php echo csrf_field(); ?>
				<div class="text-danger">
                    <input type="hidden" name="res_id" id="res_id" value="<?php echo e($data['res']->id); ?>">
					<input type="hidden" name="table_no" id="table_no" value="<?php echo e($data['table']->id); ?>">
			<?php
				if(isset($message))
				{
					echo $message;
...
<script src="<?php echo e(asset('customer/js/jquery-3.6.2.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\erp2\resources\views/customer/login.blade.php ENDPATH**/ ?>