                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 text-end">
                                <div>
                                    ...
                                    data-bs-target="#showModal"><i class="ri-add-fill me-1 align-bottom"></i> Add Category</button>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="category_list" class="display table table-bordered dt-responsive" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr. No</th>
                                                    <th>Category</th>
...
<script>
    ...
    function opendeletmodel(id)
    {
        ...
        $('#removeItemModal').modal('show');
          $("#delete-category").replaceWith('<a href="#" class="btn btn-danger m-2" id="delete-table" onclick="deleteCategory('+id+')">Yes, Delete it</a>');
    }
    ...
    function deleteCategory(id)
      ...
      function savecategory()
      {
        ...
        if($('#category_name').val() !='')
        {
            ...
            toast_error('Please Enter Category Name');
        }
      }
      ...
      function openEditmodel(id)
      {
        ...
        $.ajax({
                ...
                data: {category_id:id,seller_id:$('[name=seller_id]').val()},
                success: function(result) {
                    console.log("ajax data=", result)
                    if(result.success==true)
                    {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp2\resources\views/category.blade.php ENDPATH**/ ?>