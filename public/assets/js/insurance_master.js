  document.addEventListener('DOMContentLoaded', function () {
        ...
        schemeForm.addEventListener('submit', function (event) {
            const insuranceSchemeName = document.getElementById('insurance_scheme_name');
        ...
        // Add a submit event listener for insurerForm
        insurerForm.addEventListener('submit', function (event) {
            const insuranceCompanyName = document.getElementById('insurance_company_name');
