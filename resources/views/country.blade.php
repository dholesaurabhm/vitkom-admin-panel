                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                {{-- <input type="text" id="country_date" name="country_date" class="form-control" placeholder="Select Date" required /> --}}
                                <input type="text" class="form-control curr_date" id="country_date" name="country_date" data-provider="flatpickr" data-date-format="Y-m-d" data-deafult-date="{{date('Y-m-d')}}">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div>
