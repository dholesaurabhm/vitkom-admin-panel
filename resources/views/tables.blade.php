            ...
            { data: 'id',render:function(data,type,row){ 
                return `<div class="dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
                         <li><a class="dropdown-item edit-list" target=”_blank” href="{{url('/')}}/${row.qr_code}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
						<li class="dropdown-divider"></li>
						<li><a class="dropdown-item edit-list" data-edit-id='${data}' href="{{url('/edit_table/${data}')}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
						<li class="dropdown-divider"></li>
