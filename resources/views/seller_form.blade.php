                        ...
                        <input type="hidden" name="status" id="status" value="{{$status}}">
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="name"  placeholder="Enter Owner Name" name="name" value="{{Auth::user()->name}}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    ...
                                    <div class="form-icon">
                                        <input type="email" class="form-control form-control-icon" id="email"  placeholder="Enter Email" name="email" value="{{Auth::user()->email}}">
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="mobile_no" placeholder="Enter Mobile No" name="mobile_no" value="{{Auth::user()->name}}" maxlength="12">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-md-6">
                                <div>
                            ...
                            {{-- <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="exampleFormControlTextarea5" class="form-label">Example
                                        Textarea <span class="text-danger"> *</span></label>
