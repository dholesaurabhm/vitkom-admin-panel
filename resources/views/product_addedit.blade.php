                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <input type="hidden" name="product_id" id="product_id" value="{{$id}}">
                            ...
                            {{-- <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="placeholderInput" class="form-label">Menu Weight <span class="text-danger"> *</span></label>
                                    <input type="number" class="form-control" id="quantity" placeholder="Enter Menu Weight" name="quantity" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="State" class="form-label">Menu Package <span class="text-danger"> *</span></label>
                                    <select class="form-select" aria-label="Select Menu Package" name="packging" id="packging">
